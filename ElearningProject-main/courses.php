...
<!-- End Course Page Banner -->
 ...
 <div class="container mt-5">
        ...
        <div class="card-desk  mt-4">
            <a href="#" class="btn" style="text-align: left; padding:0px; margin:0px;">
                <div class="card padding">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Learn Java Easy Way
                        </h5>
        ...
        <!-- End All popular course 1st Card Desk -->




        <!-- Start All popular course 2st Card Desk -->
        <div class="card-desk mt-4">
            <a href="#" class="btn" style="text-align: left; padding:0px; margin:0px;">
                <div class="card padding">
                    <img src="image/c++.png" class="card-img-top" alt="C++" />
                    <div class="card-body">
                        <h5 class="card-title">Learn C++ an easy way
                        </h5>
                        <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                    </div>
        ...
        <!-- End All popular course 2st Card Desk -->
