...
$msg ='<div class="alert alert-warning col-sm-6 ml-5 mt-2"role="alert">Fill All Fields </div>';
    ...
    $corginalprice = $_REQUEST['course_orginal_price'];
...
$sql = "UPDATE course SET course_id ='$cid', course_name= '$cname',course_desc= ' $cdesc',course_author= '$cauthor', 
 course_duration= '$cduration',course_price= '$cprice', course_orginal_price= ' $corginalprice', course_img='$cimg'
 WHERE course_id = '$cid' ";
if($conn->query($sql) == TRUE){
    //below msg on form submit success
    $msg ='<div class="alert alert-success col-sm-6 ml-5 mt-2"role="alert">Updated Successfully </div>';

}else{
     //below msg on form submit failed
...
<div class="form-group">
<label for="course_orginal_price">Course Original Price</label>
<input type="text" class="form-control" id="course_orginal_price" name="course_orginal_price" value="<?php if(isset($row['course_orginal_price'])
     ){echo $row['course_orginal_price'];} ?>" >
</div>
...
</div><!-- div container fluid from header -->
